...
<h2 style="font-size:20px; margin-top:2px; margin-left:12px; padding-top:10px;"><?php echo $pageName; ?></h2>
	...
	<div style="margin-bottom:15px; margin-left:12px;">
		...
		while ($galleryRow = $conn->fetchArray($result))
		{
				++$i;
		?>
		<div class="imageRow" style="background:none; margin:0px; padding:0px; width:220px; float:left; padding-top:5px; padding-bottom:5px;">
  				<div class="set" style="background:none; margin:0px; padding:0px; width:220px">
  	  					<div class="single" style="float:left; margin-left:15px; margin-bottom:0px; background:none; float:left; width:220px;
						<?php if($i%$displayPerRow != 0) echo ' margin-right:5px;'; ?> line-height:75px;">
                                ...
                                title="<?php echo $galleryRow['shortcontents']; ?>">
    									<img src="<?php echo imager($galleryRow['image'], 180, 120, "fix"); ?>" border="0" 
